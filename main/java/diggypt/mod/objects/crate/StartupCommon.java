package diggypt.mod.objects.crate;

import diggypt.mod.Main;
import diggypt.mod.GuiHandlerRegistry;
...
public class StartupCommon
{
	...
	public static void preInitCommon()
	{
		 ...
		 */
		blockInventoryBasic = (BlockCrate)(new BlockCrate().setRegistryName("1row_inventory"));
    ...
    ForgeRegistries.ITEMS.register(itemBlockInventoryBasic);
		...
		GameRegistry.registerTileEntity(TileEntityInventoryBasic.class, "diggysgoofygems:1row_inventory");
		...
		GuiHandlerRegistry.getInstance().registerGuiHandler(new GuiHandlerCrate(), GuiHandlerCrate.getGuiID());
	}
