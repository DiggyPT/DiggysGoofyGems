...
import diggypt.mod.objects.crate.TileEntityInventoryBasic;
...
{   
  ...
  //  doesn't hurt to include it anyway...
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ)
	{
		...
		System.out.println("OMG BRO RIGHT CLICKA");
		if (worldIn.isRemote) return true;
		
		System.out.println("OMG BRO RIGHT CLICKA");
		playerIn.openGui(Main.instance, GuiHandlerCrate.getGuiID(), worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
